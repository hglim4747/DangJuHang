package com.example.tazo.upload;
...
public class MainActivity extends AppCompatActivity {
    ...
    public String SERVER = "http://172.16.35.221/JM/login.php", timestamp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //when uploadImage button is pressed 등록눌렀을때 이걸로
    ...
    //function to select a image 사진갤러리 부르는 거!
